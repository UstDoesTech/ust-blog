...
<div align="center"><img src="/images/data-mesh/data-mesh-deep-dive/images/ingest-clean-serve.png" alt="Image describing the process flow of data from ingestion, to transformation, and serving" width="900" /></div>
...
<div align="center"><img src="/images/data-mesh/data-mesh-deep-dive/images/ingest-clean-serve-throughput.png" alt="Image describing the reduced throughput as data goes through the data flow process" width="700" /></div>
...
<div align="center"><img src="/images/data-mesh/data-mesh-deep-dive/images/domain-context.png" alt="Image visualising the domain context - with O for operational capabilities and A as analytical endpoints" width="700" /></div>
...
<div align="center"><img src="/images/data-mesh/data-mesh-deep-dive/images/data-product.png" alt="The Data Product as composed by Code, Data and Infrastructure" width="700" /></div>
...
<div align="center"><img src="/images/data-mesh/data-mesh-deep-dive/images/data-product-domain-context.png" alt="Data Product in the Context of a Domain - linking to Operational System" width="700" /></div>
...
<div align="center"><img src="/images/data-mesh/data-mesh-deep-dive/images/data-product-self-serve-infra.png" alt="Logical workload process of a data product on self-service infrastructure as described above" width="900" /></div>
