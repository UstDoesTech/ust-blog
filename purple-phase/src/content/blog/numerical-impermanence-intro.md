...
> â€œFor any initial value N(tâ‚€), there exists a transformation of C(t) such that limtâ†’âˆžâ€‹N(t)â‰ N(tâ‚€) and may even become undefinedâ€
...
Here, C(t) is itself constantly changing â€” like a river flowing and altering the meaning of things as it goes (shout out to the Heraclitus fans).

### The big claim

If you pick a starting point in time (say, tâ‚€) and look at the value of the Temporal Number at that time, as time goes on (t â†’ infinity), the number will almost certainly drift away from its original value. Eventually, it might even lose meaning completely (it could become "undefined"). In seeking meaning, we could end up losing it completely (is the risk worth it? Time will tell).
