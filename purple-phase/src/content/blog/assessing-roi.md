...
1. **Estimate Performance**: Here, we're applying performance more broadly than the original definition - by focusing on the value potential. What measurable outcomes should the product improve? How large is the impact? These could include specific metrics or KPIs that the solution is expected to impact, such as revenue gain (e.g. better targeting by > Â£500k a year), cost avoidance (e.g. reducing fraud by <Â£300K a year), efficiency gains (e.g. saving 2 FTEs or ~Â£150k a year).
...
```
Estimated Performance = Â£500,000 (revenue gain)
Estimated Adoption = 0.8 (80% of target users)
Estimated Costs = Â£200,000 (total cost of the solution)
Forecasted Data ROI = (Â£500,000 * 0.8) / Â£200,000 = 2.0
```
This means that for every Â£1 invested in the data solution, the organisation expects to gain Â£2 in value.

Another example could be:

```
Estimated Performance = Â£300,000 (cost avoidance)
Estimated Adoption = 0.6 (60% of target users)
Estimated Costs = Â£150,000 (total cost of the solution)
Forecasted Data ROI = (Â£300,000 * 0.6) / Â£150,000 = 1.2
```

This means that for every Â£1 invested in the data solution, the organisation expects to gain Â£1.20 in value.

And an example of weak ROI could be:

```
Estimated Performance = Â£100,000 (efficiency gain)
Estimated Adoption = 0.5 (50% of target users)
Estimated Costs = Â£250,000 (total cost of the solution)
Forecasted Data ROI = (Â£100,000 * 0.5) / Â£250,000 = 0.2
```

This means that for every Â£1 invested in the data solution, the organisation expects to gain only Â£0.20 in value, which may not justify the investment.
...
```
Actual Performance = Â£450,000 (revenue gain)
Actual Adoption = 0.75 (75% of target users)
Actual Costs = Â£220,000 (total cost of the solution)
Actual Data ROI = (Â£450,000 * 0.75) / Â£220,000 = 1.53
