...
date: 2016-05-13
tags: []
description: "Discover the essentials of data lakes with Telefónica Tech. Learn how to manage and analyze vast amounts of data efficiently."
source: "https://telefonicatech.uk/blog/introduction-to-data-lakes/"
...
> **Migrated from [Telefonica Tech UK (formerly Adatis)](https://telefonicatech.uk/blog/introduction-to-data-lakes/)**
> Original publication date: 2016-05-13
...
In essence – we are overcoming the limitation of traditional querying by:
...
**1. Data dumping** –
It’s very easy to treat a data lake as a dumping ground for anything and everything. This will essentially create a data swamp, which no one will want to go into.

**2. Data drowning –**
the volume of the data could be massive and the velocity very fast. There is a real risk of drowning by not fully knowing what data you have in your lake. 
...
[Getting Started With Azure Data Lake Store](https://telefonicatech.uk/blog/getting-started-with-azure-data-lake-store/)

[Getting Started With Azure Data Lake Analytics and U-SQL](https://telefonicatech.uk/blog/getting-started-with-azure-data-lake-analytics-u-sql/)

[Azure Data Lake Overview](https://azure.microsoft.com/en-us/solutions/data-lake/)